...
import type { ExternalBlob as _ExternalBlob, StripeSessionStatus as _StripeSessionStatus, StudyNote as _StudyNote, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async buyStudyNote(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.buyStudyNote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createNoteListing(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createNoteListing(arg0, arg1, arg2, arg3, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createStudyNotesMarketplace(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createStudyNotesMarketplace();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAvailableStudyNotes(): Promise<Array<StudyNote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableStudyNotes();
    ...
    async getPurchasedStudyNotes(): Promise<Array<StudyNote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPurchasedStudyNotes();
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStudyNote(arg0: string): Promise<StudyNote | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudyNote(arg0);
    ...
    async getUserCredits(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserCredits();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_StudyNote_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StudyNote): Promise<StudyNote> {
...
async function from_candid_opt_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StudyNote]): Promise<StudyNote | null> {
    return value.length === 0 ? null : await from_candid_StudyNote_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        content: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.content),
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StudyNote>): Promise<Array<StudyNote>> {
    return await Promise.all(value.map(async (x)=>await from_candid_StudyNote_n12(_uploadFile, _downloadFile, x)));
}
